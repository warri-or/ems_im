...
$db['armalik_ems']['pconnect'] = TRUE;
$db['armalik_ems']['db_debug'] = TRUE;
$db['armalik_ems']['cache_on'] = FALSE;
$db['armalik_ems']['cachedir'] = '';
$db['armalik_ems']['char_set'] = 'utf8';
$db['armalik_ems']['dbcollat'] = 'utf8_general_ci';
$db['armalik_ems']['swap_pre'] = '';
$db['armalik_ems']['autoinit'] = TRUE;
$db['armalik_ems']['stricton'] = FALSE;
