...
<div class="row widget">
    ...
    if(isset($CI->permissions['column_headers'])&&($CI->permissions['column_headers']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="id"><?php echo $CI->lang->line('LABEL_FDB_NO'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DATE'); ?>', dataField: 'date',width:'90',cellsalign: 'right',pinned:true},
                    { text: '<?php echo $CI->lang->line('LABEL_EXPECTED_DATE'); ?>', dataField: 'expected_date',width:'90',cellsalign: 'right',pinned:true},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CROP_TYPE'); ?>', dataField: 'crop_type_name',filtertype: 'list',width:'80',cellsalign: 'right'},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DIVISION_NAME'); ?>', dataField: 'division_name',width:'90',cellsalign: 'right'},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DISTRICT_NAME'); ?>', dataField: 'district_name',width:'100',cellsalign: 'right'},
                    { text: '<?php echo $CI->lang->line('LABEL_UPAZILLA_NAME'); ?>', dataField: 'upazilla_name',width:'100',cellsalign: 'right'},
                    { text: '<?php echo $CI->lang->line('LABEL_REQUESTED'); ?>', dataField: 'status_requested',width:'80',cellsalign: 'right',filtertype: 'list'},
