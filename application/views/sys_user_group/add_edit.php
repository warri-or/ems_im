    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="user_group[name]" id="name" class="form-control" value="<?php echo $user_group['name'];?>"/>
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="user_group[ordering]" id="ordering" class="form-control" value="<?php echo $user_group['ordering'] ?>" >
            </div>
        </div>
    </div>
