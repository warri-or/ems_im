    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" id="date" class="form-control datepicker" value="<?php echo System_helper::display_date(time());?>"/>
            </div>
        </div>
        ...
        <div style="<?php if(!(sizeof($territories)>0)){echo 'display:none';} ?>" class="row show-grid" id="territory_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                ...
                {
                    ?>
                    <select id="territory_id" class="form-control" name="territory_id">
                        <option value=""><?php echo $this->lang->line('SELECT');?></option>
                        <?php
...
<script type="text/javascript">
    function load_schedule()
    {
        ...
        var date=$('#date').val();
        if(territory_id>0 && date)
        {
            $.ajax({
                url: '<?php echo site_url($CI->controller_url.'/index/search_list');?>',
                type: 'POST',
                datatype: "JSON",
                data:{territory_id:territory_id,date:date},
