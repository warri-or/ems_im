...
<div style="display:none;" class="row show-grid heading-label">
    <div class="col-sm-4">
    </div>
    <div class="col-sm-2 col-sm-4">
...
<div class="row show-grid">
    ...
    <div class="col-xs-4">
        <div style="<?php if(isset($video_file_details['file_location'])){echo 'display:block;';}else{echo 'display:none;';}?>" id="video_preview_container_id">
        ...
        <div>
            <input type="file" class="browse_button file_multi_video" data-preview-container="#video" name="video" accept="video/*">
...
//    jQuery(document).ready(function() (original)
//    {
//        var modal=$('#myModal');
//        $(document).on('click','.popup_image',function()
//        {
//            modal.show();
//            $('#modal-image').attr('src',$(this).attr('file-link'));
