    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="crop_id" name="type[crop_id]" class="form-control">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="type[name]" id="name" class="form-control" value="<?php echo $type['name'];?>"/>
            </div>
        </div>
        <div style="" class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <textarea name="type[description]" id="description" class="form-control"><?php echo $type['description'] ?></textarea>
            </div>
        </div>
        <div style="" class="row show-grid">
            <div class="col-xs-4">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status" name="type[status]" class="form-control">
                    <!--<option value=""></option>-->
