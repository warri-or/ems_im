...
class Tm_trainer_market_visit extends Root_Controller
{
    private $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Tm_trainer_market_visit');
        ...
        $this->controller_url='tm_trainer_market_visit';
    }
    ...
    private function system_list()
    {
        if(isset($this->permissions['view'])&&($this->permissions['view']==1))
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("tm_trainer_market_visit/list",$data,true));
            if($this->message)
            {
    ...
    public function get_items()
    {
        ...
        $this->db->order_by('mvtrainer.id DESC');
    ...
    private function system_add()
    {
        if(isset($this->permissions['add'])&&($this->permissions['add']==1))
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("tm_trainer_market_visit/add_edit",$data,true));
            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
    ...
    private function system_save()
    {
        ...
        else
        {
            ...
            $file_folder='images/trainer_market_visit/';
            ...
            if($id>0)
            {
                ...
                Query_helper::update($this->config->item('table_tm_market_visit_trainer'),$visit,array("id = ".$id));
            ...
            else
            {
                ...
                Query_helper::add($this->config->item('table_tm_market_visit_trainer'),$visit);
            }
