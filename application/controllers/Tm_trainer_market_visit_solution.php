...
class Tm_trainer_market_visit_solution extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Tm_trainer_market_visit_solution');
        ...
        $this->controller_url='tm_trainer_market_visit_solution';
    }
    ...
    private function system_list()
    {
        ...
        {
            $data['title']="Trainer Market Visit and Solution List";
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("tm_trainer_market_visit_solution/list",$data,true));
            if($this->message)
            {
    ...
    private function system_edit($id)
    {
        if((isset($this->permissions['edit'])&&($this->permissions['edit']==1))||(isset($this->permissions['add'])&&($this->permissions['add']==1)))
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("tm_trainer_market_visit_solution/add_edit",$data,true));
            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
    ...
    private function system_save()
    {
        ...
        if((isset($this->permissions['edit'])&&($this->permissions['edit']==1))||(isset($this->permissions['add'])&&($this->permissions['add']==1)))
        {
            if(strlen($solution)>0)
            {
                ...
                Query_helper::add($this->config->item('table_tm_market_visit_solution_trainer'),$data);
            }
        }
