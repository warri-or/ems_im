...
class Setup_csetup_ocustomer extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_csetup_ocustomer');
        ...
        $this->controller_url='setup_csetup_ocustomer';
    ...
    private function system_list()
    {
        ...
        {
            $data['title']="Other Customers";
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("setup_csetup_ocustomer/list",$data,true));
            if($this->message)
            {
    ...
    private function system_add()
    {
        ...
        {
            $data['title']="Create New Other Customer";
            $data["customer"] = Array(
                'id' => 0,
